...
<section class="container py-10 px-8">
    <div class="rounded-[10px] w-max text-20 leading-[22px] text-primary mb-6">Recent <b>Blogs</b></div>
        ...
        <?php while ($posts->have_posts()) : $posts->the_post(); ?>
            <div class="flex flex-1 gap-4 flex-col">
                ...
                if (has_post_thumbnail()) :
                    ...
                    <img class="relative bg-transparent z-10 w-full rounded-[10px]" src="<?php echo esc_url($featured_image_url); ?>" alt="<?php echo esc_attr($alt_text ?: get_the_title()); ?>" loading="lazy">
                <?php endif; ?>
                ...
                <h2 class="text-20 leading-5 text-primary font-semibold"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
