...
?>
<section class="container flex py-10 mdd:py-0 mdd:flex-col justify-between">
    <div class="flex flex-col w-1/2 p-8 gap-6 mdd:w-full mdd:order-2 mdd:p-4">
        ...
        <a href="#register-now" class="w-max px-5 py-[10px] rounded-[24px] bg-primary text-16 text-white font-semibold">Become a Partner</a>
    </div>
    <div class="w-1/2 lg:w-[480px] mdd:w-full mdd:order-1 mdd:px-4 py-0">
