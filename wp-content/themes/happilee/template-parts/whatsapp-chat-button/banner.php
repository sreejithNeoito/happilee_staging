<?php 
$banner_title1 = get_post_meta(get_the_ID(), 'chat_button_title_1', true);
$banner_title2 = get_post_meta(get_the_ID(), 'chat_button_title_2', true);
$banner_content = get_post_meta(get_the_ID(), 'chat_button_content', true); ?>
