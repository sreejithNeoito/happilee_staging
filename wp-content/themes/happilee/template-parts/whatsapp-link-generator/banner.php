<section class="container flex gap-10 py-10 mdd:flex-col mdd:py-0 mdd:px-5 mdd:gap-5 items-end">
    <div class="flex w-1/2 p-8 gap-6 flex-col mdd:w-full order-2 md:order-1 mdd:p-4 mdd:gap-6">
    ...
    <div class="w-1/2 lg:w-[480px] py-0 px-4 md:p-8 md:pt-0 relative mdd:w-full order-1 md:order-2">
        <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/integrations/banner.webp" alt="whatsapp link generator" loading="eager">
    </div>
</section>