        ...
        <div class="flex flex-col lg:flex-row gap-10 p-8 container bg-white rounded-[40px]">
            ...
            <div class=" space-y-6">
                ...
                <ul class="text-16 leading-6 ">
                    ...
                    <li><b>Step 2:</b> Click on 'Generate Chat Link' button</li>
            ...
            <div id="wa_form" class="flex-1">
                ...
                <div class="flex flex-col md:flex-row justify-between items-end md:items-center w-full pt-4 md:pt-0 gap-4 md:gap-0">
                    ...
                    <a id="wa_generate_btn" class="bg-primary cursor-pointer border block w-max border-primary  text-white text-16 smd:text-14 leading-5 font-semibold  py-[10px] px-5 rounded-[20px]">
                        Generate Chat Link</a>
                </div>
