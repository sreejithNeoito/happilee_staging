<section class="container py-10 px-8">
    <div class="flex gap-6 smd:flex-col">
        <div class="flex flex-1 gap-4 flex-col">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/usecases/whatsapp-chatbot.webp" alt="" class="relative bg-transparent z-10 w-full">
        ...
        <div class="flex flex-1 gap-4 flex-col">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/usecases/whatsapp-catalog.webp" alt="" class="relative bg-transparent z-10 w-full">
        ...
        <div class="flex flex-1 gap-4 flex-col">
            <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/usecases/whatsapp-marketing.webp" alt="" class="relative bg-transparent z-10 w-full">
