...
<section>
 ...
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/feat-1.webp" alt="Happilee Chatbot Builder" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">
            <div class="w-[468px] h-[480px] feature relative">
                <div class="w-[320px] h-[200px] bg-[#CCFFCC] rounded-3xl absolute bottom-7 right-[30px] person">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/person.webp" alt="Happilee Chatbot Builder" loading="lazy" class="absolute bottom-0 right-5 z-50 w-[270px] h-[320px]" width="270" height="320">
                </div>
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/box1.webp" alt="Happilee Chatbot Builder 1" loading="lazy" class="box-1 w-[160px] h-[250px]" width="160" height="250">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/box2.webp" alt="Happilee Chatbot Builder 2" loading="lazy" class="box-2 w-[200px] h-[144px]" width="200" height="144">
                ...
                <div class="box-3">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/box3.webp" alt="Happilee Chatbot Builder 3" width="200" height="174" loading="lazy" class="w-[200px] h-[174px]">
...
">
 ...
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/feat-2.webp" alt="WhatsApp Shared Team Inbox" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <div class="w-[320px] h-[200px] bg-[#FFDDD6] rounded-3xl absolute bottom-0 left-5 right-0 person">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/person.webp" alt="WhatsApp Shared Team Inbox" loading="lazy" class="absolute bottom-0 left-5 z-50 w-[240px] h-[320px]" width="240" height="320">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box1.webp" alt="WhatsApp Shared Team Inbox 1" loading="lazy" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box2.webp" alt="WhatsApp Shared Team Inbox 2" loading="lazy" class="box-2">
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box3.webp" alt="WhatsApp Shared Team Inbox 3" loading="lazy" class="box-3">
            </div>
        </div>
    </div>
    ...
    <div id="feat-three" class="container flex lgmd:flex-col py-10 gap-6 mdd:flex-col mdd:py-5">
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/feat-3.webp" alt="WhatsApp Broadcast Messages" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box1.webp" alt="WhatsApp Broadcast Messages 1" loading="lazy" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box2.webp" alt="WhatsApp Broadcast Messages 2" loading="lazy" class="box-2">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/person.webp" width="360"
                    height="320" alt="WhatsApp Broadcast Messages" loading="lazy" class="absolute right-5 z-50 person bottom-[50px]">
                <div class="box-3">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box3.webp" alt="WhatsApp Broadcast Messages 3" loading="lazy">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box4.webp" alt="WhatsApp Broadcast Messages 4" loading="lazy" class="box-4">
            </div>
...
">
        ...
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/feat-4.webp" alt="WhatsApp Commerce Store" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <div class="w-[320px] h-[200px] bg-[#CCFFCC] rounded-3xl absolute bottom-0 right-5 person">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/person.webp" alt="WhatsApp Commerce Store" loading="lazy" class="absolute bottom-0 z-50">
                </div>

                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/box1.webp" alt="WhatsApp Commerce Store 1" loading="lazy" class="box-1">
                <div class="box-2">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/box2.webp" alt="WhatsApp Commerce Store 2" loading="lazy" >
                ...
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/box3.webp" loading="lazy" class="box-3">
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/box4.webp" loading="lazy" class="box-4">
            </div>
        </div>
    </div>
    ...
    <div id="feat-five" class="container flex lgmd:flex-col py-10 gap-6 mdd:flex-col mdd:py-5">
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/feat-5.webp" alt="WhatsApp Scheduler" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/box3.webp" alt="WhatsApp Scheduler 1" loading="lazy" class="box-3">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/box2.webp" alt="WhatsApp Scheduler 2" loading="lazy" class="box-2">
                <div class="w-[320px] h-[200px] bg-[#FFDDD6] rounded-3xl absolute bottom-11 right-5 person">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/person.webp" alt="WhatsApp Scheduler 3" loading="lazy" class="absolute z-50 bottom-0">
                </div>
                <div class="box-1">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/box1.webp" alt="WhatsApp Scheduler 4" loading="lazy">
...
">
        ...
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/feat-6.webp" alt="Meta Leads CRM" loading="lazy" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <div class="w-[320px] h-[200px] bg-[#CEE1F5] rounded-3xl absolute bottom-[26px] right-5 person">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/person.webp" alt="Meta Leads CRM" loading="lazy" class="absolute bottom-0">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box1.webp" alt="Meta Leads CRM 1" loading="lazy" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box2.webp" alt="Meta Leads CRM 2" loading="lazy" class="box-2">
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box3.webp" alt="Meta Leads CRM 3" loading="lazy" class="box-3">
            </div>
        </div>
    </div>
</section>