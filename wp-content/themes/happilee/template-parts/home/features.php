<section>
 ...
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            ...
            <div class="w-[468px] h-[480px] feature relative">
                ...
                <div class="box-3">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/1/box3.webp" width="200" height="174" class="w-[200px] h-[174px]">
...
">
 ...
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/feat-2.webp" alt="" class="relative bg-transparent z-10 w-full feat-image">
            ...
            <div class="w-[468px] h-[480px] feature relative">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box1.webp" alt="" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box2.webp" alt="" class="box-2">
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/2/box3.webp" class="box-3">
            </div>
        </div>
    </div>
    ...
    <div id="feat-three" class="container flex lgmd:flex-col py-10 gap-6 mdd:flex-col mdd:py-5">
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/feat-3.webp" alt="" class="relative bg-transparent z-10 w-full feat-image">

            <div class="w-[468px] h-[480px] feature relative">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box1.webp" alt="" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box2.webp" alt="" class="box-2">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/3/box4.webp" alt="" class="box-4">
            </div>
...
">
        ...
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/feat-4.webp" alt="" class="relative bg-transparent z-10 w-full feat-image">
            ...
            <div class="w-[468px] h-[480px] feature relative">
                ...
                <div class="box-2">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/4/box2.webp" alt="">
    ...
    <div id="feat-five" class="container flex lgmd:flex-col py-10 gap-6 mdd:flex-col mdd:py-5">
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container items-start">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/5/feat-5.webp" alt="" class="relative bg-transparent z-10 w-full feat-image">
...
">
        ...
        <div class="w-1/2 md:w-[480px]
 mdd:order-1 lgmd:w-full relative feature-container">
            <img data-aos="zoom-in" src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/feat-6.webp" alt="" class="relative bg-transparent z-10 w-full feat-image">
            ...
            <div class="w-[468px] h-[480px] feature relative">
                ...
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box1.webp" alt="" class="box-1">
                <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box2.webp" alt="" class="box-2">
                <img src=" <?php echo get_stylesheet_directory_uri() ?>/assets/images/features/6/box3.webp" class="box-3">
            </div>
        </div>
    </div>
</section>