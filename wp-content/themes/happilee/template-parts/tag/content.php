        ...
        <div class="grid grid-cols-3 gap-6 smd:grid-cols-1">
            <?php while ($query->have_posts()) : $query->the_post(); ?>
                <div class="flex flex-1 gap-4 flex-col">
                    ...
                    <h2>
                        <a href="<?php the_permalink(); ?>" class="text-20 leading-5 text-primary font-semibold"><?php the_title(); ?></a>
                    </h2>
        ...
        if ($pagination_links) : ?>
            <div class="flex justify-between items-center mt-10 lgmd:flex-col smd:items-start">
                ...
                <div class="pagination-container flex justify-center items-center gap-4 smd:gap-2">
                    <?php if ($paged > 1) : ?>
                        <a class="rounded-lg px-2 py-2 bg-bg-footer" href="<?php echo esc_url(get_pagenum_link(1)); ?>" aria-label="First Page">
                    ...
                    <?php if ($paged < $query->max_num_pages) : ?>
                        <a class="rounded-lg px-2 py-2 bg-bg-footer" href="<?php echo get_pagenum_link($query->max_num_pages); ?>" aria-label="Last Page">
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
