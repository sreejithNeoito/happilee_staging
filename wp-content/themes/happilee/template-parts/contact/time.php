<section class="mdd:p-5">
    <div class="container  text-primary py-10">
        <div class="grid grid-cols-1 md:grid-cols-3 bg-white rounded-[40px]">
            ...
            <div class="w-full space-y-6 p-8">
                ...
                <div class="space-y-1 text-sm max-w-[235px]">
                    <div class="flex justify-between">
                        <span class="text-16 leading-6 font-bold">Monday:</span>
                        <span class="text-16 leading-6">09:00AM - 19:00PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-16 leading-6 font-bold">Tuesday:</span>
                        <span class="text-16 leading-6">09:00AM - 19:00PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-16 leading-6 font-bold">Wednesday:</span>
                        <span class="text-16 leading-6">09:00AM - 19:00PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-16 leading-6 font-bold">Thursday:</span>
                        <span class="text-16 leading-6">09:00AM - 19:00PM</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-16 leading-6 font-bold">Friday:</span>
                        <span class="text-16 leading-6">09:00AM - 19:00PM</span>
                    </div>
                </div>
            </div>
